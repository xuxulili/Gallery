package com.data.gallery.gallery.ui.view;
 ...
 */
public class ImgTouchView extends ImageView {
     ...
     * @param context
     */
    public ImgTouchView(Context context){
        super(context);
    }
    /**
     ...
     */
    public ImgTouchView(Context context,AttributeSet paramAttributeSet){
